...
//    WeatherView(
//      weather: WeatherPublisher(location: nil),
//      bgColors: $bgColors,
//      index: 0
//    )
//    .tabItem {
...
//    }
//    .tabFullScreenBackground(geo: geo, colors: bgColors[0])
//    .tag(0)
//  }
//
//  func locationWeatherView(_ location: Location, geo: GeometryProxy) -> some View {
//    WeatherView(
//      weather: WeatherPublisher(location: location),
//      bgColors: $bgColors,
//      index: indexOfLocation(location)
//    )
//    .tabFullScreenBackground(geo: geo, colors: colorsForLocation(location))
...
//  }
//
//  func colorsForLocation(_ location: Location) -> [Color] {
